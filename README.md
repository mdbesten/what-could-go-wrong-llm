...
The Card Czar then pulls a black prompt card and reads it to the group.
All other players then put 1 white response card face down in their slot.
The Card Czar then flips and reads each white card out loud.
The Card Czar then picks one of the white cards to further discuss. +1 point goes to the player whose card was chosen.
The group then discusses further what else could go wrong based on the chosen card. People can award +1 point to anyone who makes a good point in the discussion.
After the discussion dissipates after a few minutes, the next player becomes the Card Czar and clicks the “Deal” button. Each player then draws a new white card, so that they again have 5 cards in their hand.

## During the game

Take notes on ideas that you have not thought about before.
Some of the cards are causes, others are effects. Don’t worry about what the game designers intended with each card, go where the discussion is best.
Some of the cards may be upsetting. (Such as, a person is abused.)
It’s fine to take time to have discussion.
Try not to get side tracked, though!
