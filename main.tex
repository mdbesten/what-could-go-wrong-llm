...
\begin{multicols}{2}
    \begin{enumerate}\tiny \setlength\itemsep{.2ex}
        ...
        \item The group then discusses further what else could go wrong based on the chosen card. People can award +1 point anyone who makes a good point in discussion. Each response card has prompts to lead the discussion.
