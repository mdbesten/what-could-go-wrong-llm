...
\begin{multicols}{2}
    \begin{enumerate}\tiny \setlength\itemsep{.2ex}
        ...
        \item Each player then draws a new white card, so that they again have 5 cards in their hand.
        \item Rotate the role of Card Czar to the next team, and continue playing until a predetermined point goal is reached. 3 points is a good goal for a short game.
        \item Optional: Introduce a "Wildcard Round" where players can play any card from their hand instead of following the prompt. 
        \item Encourage players to swap event cards with each other before submitting them to the Card Czar. 
