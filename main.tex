...
\begin{multicols}{2}
    \begin{enumerate}\tiny \setlength\itemsep{.2ex}
        ...
        \item After the discussion dissipates after a few minutes, the player to the left of the Card Czar becomes the Card Czar. Each player then draws a new white card, so that they again have 5 cards in their hand.
    \end{enumerate}
    \end{multicols}
\end{flashcard}
