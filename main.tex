...
\DTLforeach{prompt}{%
    ...
    \Category=LABEL,%
    \Id=NUMBERS%
    %% Add choice of language: French or English
    \promptlanguage=\DTLfetch{prompt}{ID}{\deck:\quad\Id}{LANGUAGE}%
}{%%%  Start designing your output text!
\begin{flashcard}[\deck:\quad\Id\quad\DTLifnull{\Category}{}{\Category}\quad Language: \promptlanguage]{%
...
\begin{flashcard}[\deck:\quad\Id\quad\DTLifnull{\Category}{}{\Category} \quad Language: \responselanguage]{%
\Description
}
