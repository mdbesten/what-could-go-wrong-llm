...
\begin{multicols}{2}
    \begin{enumerate}\tiny \setlength\itemsep{.2ex}
        ...
        \item The group then discusses further what else could go wrong based on the chosen card. At the end of the discussion an anonymous poll is launched and the player with the highest number of votes gets +1 point.
